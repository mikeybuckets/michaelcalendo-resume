          ...
          <div className='text-center pb-12 md:pb-16'>
            ...
            <div className='max-w-3xl mx-auto'>
              ...
              >
                <div>
                  <a
                    className='btn text-white bg-gray-500 hover:bg-purple-600 w-full mb-4 sm:w-auto sm:mb-0'
                    href='#0'
                  >
                    Start free trial
                  </a>
                ...
                <div>
                  <a
                    className='btn text-white bg-purple-800 hover:bg-purple-600 w-full sm:w-auto sm:ml-4'
                    href='#0'
                  >
                    Learn more
                  </a>
