          ...
          <div className='text-center pb-12 md:pb-16'>
            ...
            <div className='max-w-3xl mx-auto'>
              ...
              >
                <div>
                  <a
                    className='btn text-white bg-gray-500 hover:bg-purple-200 hover w-full mb-4 sm:w-auto sm:mb-0'
                    href='#0'
                  >
                    Get Started
                  </a>
                ...
                <div>
                  <a
                    className='btn text-purple-200 hover:text-gray-100 bg-purple-700 hover:bg-purple-800 w-full sm:w-auto sm:ml-4'
                    href='#0'
                  >
                    Learn more
                  </a>
