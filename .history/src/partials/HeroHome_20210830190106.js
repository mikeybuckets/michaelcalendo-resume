          ...
          <div className='text-center pb-12 md:pb-16'>
            ...
            <div className='max-w-3xl mx-auto'>
              ...
              >
                ...
                <div>
                  <a
                    className='btn text-white hover:text-white bg-purple-700 hover:bg-purple-800 w-full sm:w-auto sm:ml-4'
                    href='#0'
                  >
                    Learn more
                  </a>
            ...
            >
              <div className='flex flex-col justify-center'>
                <img
                  ...
                  src={
                    url(
                      "https://divoperations.com/resources/logos/DivOps/hero-orbs-purple-black.png"
                    ).default
                  }
                  width='768'
                  height='432'
